...
public class Mashable extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_mashable, container, false);
        swipeRefreshLayout =
...
//        recyclerView.setLayoutManager(staggeredGridLayoutManager);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                getFragmentManager().beginTransaction().replace(R.id.fragment_cont, new Mashable()).commit();
            }
        });
    ...
    private void loadJSON(){
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        InterfaceMashable request = retrofit.create(InterfaceMashable.class);
