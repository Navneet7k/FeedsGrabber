...
public class Techcrunch extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_techcrunch, container, false);
        swipeRefreshLayout =
...
//        recyclerView.setLayoutManager(gridLayoutManager);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                getFragmentManager().beginTransaction().replace(R.id.fragment_cont, new Techcrunch()).commit();
            }
        });
    ...
    private void loadJSON(){
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        InterfaceTechcrunch request = retrofit.create(InterfaceTechcrunch.class);
